...
<div className="tooth-implants-main-container">
    ...
    <div className="tooth-implants-container order2">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Know More </span> about the transformative impact of single tooth implants.</p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Book an Appointment  </span>to restore the integrity of your smile. </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back </span>for expert guidance on single tooth implants </p></li>
        </ul>
    </div>
</div>
...
<div className="tooth-implants-main-container">
    <div className="tooth-implants-container">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Learn More about the advantages  </span> of multiple implants. </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Schedule Your Consultation </span> to begin your journey to full dental restoration.  </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back </span>  to discuss your multiple implant options.</p></li>
        </ul>
    </div>
    <div>
...
<div className="tooth-implants-main-container">
    ...
    <div className="tooth-implants-container order2">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Discover More </span> about the All on 4 treatment concept </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Book an Appointment  </span> for  comprehensive evaluation. </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back </span> to explore if All on 4 is right for you. </p></li>
        </ul>
    </div>
</div>
...
<div className="tooth-implants-main-container">
    <div className="tooth-implants-container">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Read  More </span> about the benefits of All on 6/8 implants.</p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Arrange an Appointment  </span> to assess your suitability for this procedure </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back</span>  for personalized advice on All on 6/8 implants. </p></li>
        </ul>
    </div>
    <div>
...
<div className="tooth-implants-information-container one">
    <div className="tooth-implants-info-button">
        <div>
            <Link to="/contact">
                <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874376/Frame_39_1_qzj9tv.png" className="tooth-implants-booking-button" alt="know" /> 
            </Link>
        </div>
        <div>
            <Link to="/contact">
                <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874390/Frame_40_1_kmxiau.png" className="tooth-implants-booking-button" alt="know" />
            </Link>
        </div>
        <div>
            <Link to="/contact">
                <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874395/Frame_41_1_igoxqt.png" className="tooth-implants-booking-button" alt="know" /> 
            </Link>
        </div>
    </div>
</div>
<div className="tooth-implants-main-container">
    ...
    <div className="tooth-implants-container order2">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Find Out More </span> about the role of micro implants in orthodontics. </p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Book an Appointment  </span> to see how micro implants can enhance your treatment.</p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back </span> for further information on micro implants </p></li>
        </ul>
    </div>
</div>
<div className="tooth-implants-information-container">
    <div className="tooth-implants-info-button">
        <div>
            <Link to="/contact">
...
<div className="tooth-implants-main-container">
    <div className="tooth-implants-container">
        ...
        <ul className="tooth-implants-unordered-list-desc">
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span">Explore More</span> about bone grafting and its importance in implant dentistry</p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Schedule Your Bone Assessment  </span>t with our specialists</p></li>
            <li> <p className="tooth-implants-unordered-list-para"> <span className="tooth-implants-unordered-list-span"> Request a Call Back </span> to understand if bone grafting is necessary for you. </p></li>
        </ul> 
    </div>
    <div>
