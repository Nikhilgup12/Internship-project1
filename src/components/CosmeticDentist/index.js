         ...
         <div className="landing-main-container">
            ...
            <div className="cosmetic-bottom-main-container">
                <div className="cosmetic-bottom-container">
                    <p className="bottom-para"> <span className="botton-span-para"> Embrace the Art of a Beautiful Smile. </span> Are you ready to transform your smile with Tech Smiles? Contact us today to schedule your appointment and take the first step towards the smile you deserve. </p>
                </div>
            </div>
