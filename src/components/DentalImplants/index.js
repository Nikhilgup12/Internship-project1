...
const DentalImplants =()=>{
    ...
    <div>
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716869453/unsplash_7lBJaJpS3z4_gvvi30.png" className="dental-implants-image"/> 
    </div>
</div>
<div className="dental-implants-main-container">
    <div className="order1">
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716869448/unsplash_8BkF0sTC6Uo_rd4qbh.png" className="dental-implants-image"/> 
    </div>
...
<div className="dental-implants-information-container">
    <div className="dental-implants-info-button">
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716873218/Frame_39_jfvxcu.png" className="dental-implants-booking-button"/> 
        </div>
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716873213/Frame_40_v8bq08.png"  className="dental-implants-booking-button"/>
        </div>
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716873210/Frame_41_jlvtba.png" className="dental-implants-booking-button" /> 
        </div>
    </div>
</div> 
<div className="dental-implants-main-container">
    ...
    <div>
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716869441/unsplash_Pc0ToyoR5Xo_meyt77.png" className="dental-implants-image"/> 
    </div>
</div>
<div className="dental-implants-information-container one">
    <div className="dental-implants-info-button">
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874376/Frame_39_1_qzj9tv.png" className="dental-implants-booking-button"/> 
        </div>
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874390/Frame_40_1_kmxiau.png"  className="dental-implants-booking-button"/>
        </div>
        <div>
            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874395/Frame_41_1_igoxqt.png" className="dental-implants-booking-button" /> 
        </div>
    </div>
</div> 
<div className="dental-implants-main-container">
    <div className="order1">
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716869434/unsplash_NtyeAi5JeQU_srkuoc.png" className="dental-implants-image"/> 
    </div>
    <div className="dental-implants-container order2">
...
<div className="dental-implants-main-container">
    ...
    <div>
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716869406/unsplash_1AhGNGKuhR0_glvoc0.png" className="dental-implants-image"/> 
    </div>
</div>
<div className="dental-implants-information-container one">
    <div className="dental-implants-info-button">
...
<div className="dental-implants-main-container">
    ...
    <div>
        <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874734/unsplash_fmB7IdFjhTM_1_d5dltx.png" className="dental-implants-image"/> 
    </div>
</div>
