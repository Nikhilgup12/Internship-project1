        ...
        <div className="landing-main-container">
            ...
            <div className="dental-implants-information-container one">
                <div className="dental-implants-info-button">
                    <div>
                        <Link to="/contact">
                            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874376/Frame_39_1_qzj9tv.png" className="dental-implants-booking-button" alt="know" /> 
                        </Link>
                    </div>
                    <div>
                        <Link to="/contact">
                            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874390/Frame_40_1_kmxiau.png"  className="dental-implants-booking-button" alt="know" />
                        </Link>
                    </div>
                    <div>
                        <Link to="/contact">
                            <img src="https://res.cloudinary.com/di9qg5ka6/image/upload/v1716874395/Frame_41_1_igoxqt.png" className="dental-implants-booking-button" alt="know" /> 
                        </Link>
                    </div>
                </div>
            </div>
